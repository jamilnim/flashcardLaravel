...
function Oe(r4, e, t) {
  ...
  function a() {
    let c = e(""), b = { ...c ? { title: `<title inertia="">${c}</title>` } : {} }, x2 = Object.values(i).reduce((R2, T) => R2.concat(T), []).reduce((R2, T) => {
      if (T.indexOf("<") === -1) return R2;
      if (T.indexOf("<title ") === 0) {
        let N = T.match(/(<title [^>]+>)(.*?)(<\/title>)/);
        return R2.title = N ? `${N[1]}${e(N[2])}${N[3]}` : T, R2;
      }
      let pe2 = T.match(/ inertia="[^"]+"/);
      return pe2 ? R2[pe2[0]] = T : R2[Object.keys(R2).length] = T, R2;
    }, b);
...
function q2({ children: o, initialPage: t, initialComponent: a, resolveComponent: i, titleCallback: s, onHeadUpdate: f2 }) {
  let [l2, m2] = (0, import_react2.useState)({ component: a || null, page: t, key: null }), u = (0, import_react2.useMemo)(() => Oe(typeof window > "u", s || ((c) => c), f2 || (() => {
  })), []);
  if (me2 || (Qr.init({ initialPage: t, resolveComponent: i, swapComponent: async (c) => ge2(c) }), me2 = true), (0, import_react2.useEffect)(() => {
    ge2 = async ({ component: c, page: e, preserveState: d }) => {
      if (ne2) {
        ne2 = false;
        return;
      }
      m2((r4) => ({ component: c, page: e, key: d ? r4.key : Date.now() }));
    }, Qr.on("navigate", () => u.forceUpdate());
  }, []), !l2.component) return (0, import_react2.createElement)(B2.Provider, { value: u }, (0, import_react2.createElement)(V2.Provider, { value: l2.page }, null));
  let g2 = o || (({ Component: c, props: e, key: d }) => {
    let r4 = (0, import_react2.createElement)(c, { key: d, ...e });
    return typeof c.layout == "function" ? c.layout(r4) : Array.isArray(c.layout) ? c.layout.concat(r4).reverse().reduce((h, F2) => (0, import_react2.createElement)(F2, { children: h, ...e })) : r4;
  });
  return (0, import_react2.createElement)(B2.Provider, { value: u }, (0, import_react2.createElement)(V2.Provider, { value: l2.page }, g2({ Component: l2.component, key: l2.key, props: l2.page.props })));
}
q2.displayName = "Inertia";
async function Pe2({ id: o = "app", resolve: t, setup: a, title: i, progress: s = {}, page: f2, render: l2 }) {
  let m2 = typeof window > "u", u = m2 ? null : document.getElementById(o), g2 = f2 || JSON.parse(u.dataset.page), c = (r4) => Promise.resolve(t(r4)).then((h) => h.default || h), e = [], d = await Promise.all([c(g2.component), Qr.decryptHistory().catch(() => {
  })]).then(([r4]) => a({ el: u, App: q2, props: { initialPage: g2, initialComponent: r4, resolveComponent: c, titleCallback: i, onHeadUpdate: m2 ? (h) => e = h : null } }));
  if (!m2 && s && Ne(s), m2) {
    let r4 = await l2((0, import_react.createElement)("div", { id: o, "data-page": JSON.stringify(g2) }, d));
    return { head: e, body: r4 };
  }
}
function J2() {
  let o = (0, import_react6.useContext)(V2);
  if (!o) throw new Error("usePage must be used within the Inertia component");
  return o;
}
var he2 = (o) => (o = new URL(o.href), o.hash = "", o);
var $e2 = (o, t) => he2(o).href === he2(t).href;
var Fe2 = ({ children: o, data: t, fallback: a }) => {
  if (!t) throw new Error("`<Deferred>` requires a `data` prop to be a string or array of strings");
  let [i, s] = (0, import_react5.useState)(false), f2 = J2().props, l2 = (0, import_react5.useMemo)(() => Array.isArray(t) ? t : [t], [t]);
  return (0, import_react5.useEffect)(() => {
    let m2 = Se2.on("start", (u) => {
      let g2 = u.detail.visit.only.length > 0 || u.detail.visit.except.length > 0, c = u.detail.visit.only.find((e) => l2.includes(e));
      $e2(u.detail.visit.url, window.location) && (!g2 || c) && s(false);
    });
    return () => {
      m2();
    };
  }, []), (0, import_react5.useEffect)(() => {
    s(l2.every((m2) => f2[m2] !== void 0));
  }, [f2, l2]), i ? o : a;
};
Fe2.displayName = "InertiaDeferred";
var We2 = Fe2;
var ze = function({ children: o, title: t }) {
  let a = (0, import_react7.useContext)(B2), i = (0, import_react7.useMemo)(() => a.createProvider(), [a]);
  (0, import_react7.useEffect)(() => (i.reconnect(), i.update(c(o)), () => {
    i.disconnect();
  }), [i, o, t]);
  function s(e) {
  ...
  function l2(e) {
    return typeof e.props.children == "string" ? e.props.children : e.props.children.reduce((d, r4) => d + m2(r4), "");
  }
  function m2(e) {
    let d = f2(e);
    return e.props.children && (d += l2(e)), e.props.dangerouslySetInnerHTML && (d += e.props.dangerouslySetInnerHTML.__html), s(e) || (d += `</${e.type}>`), d;
  }
  function u(e) {
  ...
  function c(e) {
    let d = import_react7.default.Children.toArray(e).filter((r4) => r4).map((r4) => g2(r4));
...
var Ce2 = (0, import_react8.forwardRef)(({ children: o, as: t = "a", data: a = {}, href: i, method: s = "get", preserveScroll: f2 = false, preserveState: l2 = null, replace: m2 = false, only: u = [], except: g2 = [], headers: c = {}, queryStringArrayFormat: e = "brackets", async: d = false, onClick: r4 = R, onCancelToken: h = R, onBefore: F2 = R, onStart: A2 = R, onProgress: E2 = R, onFinish: Y2 = R, onCancel: j2 = R, onSuccess: G2 = R, onError: M2 = R, prefetch: T = false, cacheFor: k2 = 0, ...C2 }, X2) => {
  let [$2, L2] = (0, import_react8.useState)(0), H2 = (0, import_react8.useRef)(null);
  t = t.toLowerCase(), s = typeof i == "object" ? i.method : s.toLowerCase();
  let [Z2, ee2] = Ce(s, typeof i == "object" ? i.url : i || "", a, e), w2 = Z2;
  a = ee2;
  let I2 = { data: a, method: s, preserveScroll: f2, preserveState: l2 ?? s !== "get", replace: m2, only: u, except: g2, headers: c, async: d }, W2 = { ...I2, onCancelToken: h, onBefore: F2, onStart(p) {
    L2((P2) => P2 + 1), A2(p);
  }, onProgress: E2, onFinish(p) {
    L2((P2) => P2 - 1), Y2(p);
  }, onCancel: j2, onSuccess: G2, onError: M2 }, K2 = () => {
    Qr.prefetch(w2, I2, { cacheFor: te2 });
  ...
  let _2 = { onClick: (p) => {
    r4(p), $e(p) && (p.preventDefault(), Qr.visit(w2, W2));
  } }, re2 = { onMouseEnter: () => {
    ...
    r4(p), $e(p) && p.preventDefault();
  } };
  return s !== "get" && (t = "button"), (0, import_react8.createElement)(t, { ...C2, ...{ a: { href: w2 }, button: { type: "button" } }[t] || {}, ref: X2, ...D2.includes("hover") ? re2 : D2.includes("click") ? oe2 : _2, "data-loading": $2 > 0 ? "" : void 0 }, o);
});
Ce2.displayName = "InertiaLink";
var tt2 = Ce2;
function U2(o, t) {
  let [a, i] = (0, import_react10.useState)(() => {
    let s = Qr.restore(t);
    return s !== void 0 ? s : o;
  });
...
function xe2(o, t) {
  let a = (0, import_react9.useRef)(null), i = typeof o == "string" ? o : null, [s, f2] = (0, import_react9.useState)((typeof o == "string" ? t : o) || {}), l2 = (0, import_react9.useRef)(null), m2 = (0, import_react9.useRef)(null), [u, g2] = i ? U2(s, `${i}:data`) : (0, import_react9.useState)(s), [c, e] = i ? U2({}, `${i}:errors`) : (0, import_react9.useState)({}), [d, r4] = (0, import_react9.useState)(false), [h, F2] = (0, import_react9.useState)(false), [A2, E2] = (0, import_react9.useState)(null), [Y2, j2] = (0, import_react9.useState)(false), [G2, M2] = (0, import_react9.useState)(false), T = (0, import_react9.useRef)((n2) => n2), k2 = (0, import_react9.useMemo)(() => !isEqual(u, s), [u, s]);
  (0, import_react9.useEffect)(() => (a.current = true, () => {
    a.current = false;
  }), []);
  let C2 = (0, import_react9.useCallback)((...n2) => {
    let p = typeof n2[0] == "object", P2 = p ? n2[0].method : n2[0], b = p ? n2[0].url : n2[1], y2 = (p ? n2[1] : n2[2]) ?? {}, ce2 = { ...y2, onCancelToken: (S2) => {
      if (l2.current = S2, y2.onCancelToken) return y2.onCancelToken(S2);
    }, onBefore: (S2) => {
      if (j2(false), M2(false), clearTimeout(m2.current), y2.onBefore) return y2.onBefore(S2);
    }, onStart: (S2) => {
      if (F2(true), y2.onStart) return y2.onStart(S2);
    }, onProgress: (S2) => {
      if (E2(S2), y2.onProgress) return y2.onProgress(S2);
    }, onSuccess: (S2) => {
      if (a.current && (F2(false), E2(null), e({}), r4(false), j2(true), M2(true), f2(cloneDeep(u)), m2.current = setTimeout(() => {
        a.current && M2(false);
      }, 2e3)), y2.onSuccess) return y2.onSuccess(S2);
    }, onError: (S2) => {
      if (a.current && (F2(false), E2(null), e(S2), r4(true)), y2.onError) return y2.onError(S2);
    }, onCancel: () => {
      if (a.current && (F2(false), E2(null)), y2.onCancel) return y2.onCancel();
    }, onFinish: (S2) => {
      if (a.current && (F2(false), E2(null)), l2.current = null, y2.onFinish) return y2.onFinish(S2);
    } };
    P2 === "delete" ? Qr.delete(b, { ...ce2, data: T.current(u) }) : Qr[P2](b, T.current(u), ce2);
  }, [u, e, T]), X2 = (0, import_react9.useCallback)((n2, p) => {
    g2(typeof n2 == "string" ? (P2) => set(cloneDeep(P2), n2, p) : typeof n2 == "function" ? (P2) => n2(P2) : n2);
  }, [g2]), [$2, L2] = (0, import_react9.useState)(false), H2 = (0, import_react9.useCallback)((n2, p) => {
    typeof n2 > "u" ? (f2(u), L2(true)) : f2((P2) => typeof n2 == "string" ? set(cloneDeep(P2), n2, p) : Object.assign(cloneDeep(P2), n2));
  }, [u, f2]);
  (0, import_react9.useLayoutEffect)(() => {
    $2 && (k2 && f2(u), L2(false));
  }, [$2]);
  let Z2 = (0, import_react9.useCallback)((...n2) => {
    n2.length === 0 ? g2(s) : g2((p) => n2.filter((P2) => has(s, P2)).reduce((P2, b) => set(P2, b, get(s, b)), { ...p }));
  }, [g2, s]), ee2 = (0, import_react9.useCallback)((n2, p) => {
    e((P2) => {
      let b = { ...P2, ...typeof n2 == "string" ? { [n2]: p } : n2 };
      return r4(Object.keys(b).length > 0), b;
    });
  }, [e, r4]), w2 = (0, import_react9.useCallback)((...n2) => {
    e((p) => {
      let P2 = Object.keys(p).reduce((b, y2) => ({ ...b, ...n2.length > 0 && !n2.includes(y2) ? { [y2]: p[y2] } : {} }), {});
      return r4(Object.keys(P2).length > 0), P2;
    });
  }, [e, r4]), I2 = (n2) => (p, P2) => {
    C2(n2, p, P2);
  }, W2 = (0, import_react9.useCallback)(I2("get"), [C2]), K2 = (0, import_react9.useCallback)(I2("post"), [C2]), D2 = (0, import_react9.useCallback)(I2("put"), [C2]), te2 = (0, import_react9.useCallback)(I2("patch"), [C2]), _2 = (0, import_react9.useCallback)(I2("delete"), [C2]), re2 = (0, import_react9.useCallback)(() => {
    l2.current && l2.current.cancel();
  }, []), oe2 = (0, import_react9.useCallback)((n2) => {
    T.current = n2;
  }, []);
  return { data: u, setData: X2, isDirty: k2, errors: c, hasErrors: d, processing: h, progress: A2, wasSuccessful: Y2, recentlySuccessful: G2, transform: oe2, setDefaults: H2, reset: Z2, setError: ee2, clearErrors: w2, submit: C2, get: W2, post: K2, put: D2, patch: te2, delete: _2, cancel: re2 };
}
function Ie(o, t = {}, a = { keepAlive: false, autoStart: true }) {
  let i = (0, import_react11.useRef)(Qr.poll(o, t, { ...a, autoStart: false }));
  return (0, import_react11.useEffect)(() => ((a.autoStart ?? true) && i.current.start(), () => i.current.stop()), []), { stop: i.current.stop, start: i.current.start };
}
function Ae2(o = {}) {
  let t = typeof window > "u" ? null : Qr.getCached(window.location.pathname, o), a = typeof window > "u" ? null : Qr.getPrefetching(window.location.pathname, o), [i, s] = (0, import_react12.useState)((t == null ? void 0 : t.staleTimestamp) || null), [f2, l2] = (0, import_react12.useState)(a !== null), [m2, u] = (0, import_react12.useState)(t !== null);
  return (0, import_react12.useEffect)(() => {
    let g2 = Qr.on("prefetching", (e) => {
      e.detail.visit.url.pathname === window.location.pathname && l2(true);
    }), c = Qr.on("prefetched", (e) => {
      e.detail.visit.url.pathname === window.location.pathname && (l2(false), u(true), s(e.detail.fetchedAt));
    });
    return () => {
      c(), g2();
    };
  }, []), { lastUpdatedAt: i, isPrefetching: f2, isPrefetched: m2, flush: () => Qr.flush(window.location.pathname, o) };
}
var Ee2 = ({ children: o, data: t, params: a, buffer: i, as: s, always: f2, fallback: l2 }) => {
  f2 = f2 ?? false, s = s ?? "div", l2 = l2 ?? null;
  let [m2, u] = (0, import_react13.useState)(false), g2 = (0, import_react13.useRef)(false), c = (0, import_react13.useRef)(false), e = (0, import_react13.useRef)(null), d = (0, import_react13.useCallback)(() => {
    if (t) return { only: Array.isArray(t) ? t : [t] };
    if (!a) throw new Error("You must provide either a `data` or `params` prop.");
    return a;
  }, [a, t]);
  return (0, import_react13.useEffect)(() => {
    if (!e.current) return;
    let r4 = new IntersectionObserver((h) => {
      if (!h[0].isIntersecting || (!f2 && g2.current && r4.disconnect(), c.current)) return;
      g2.current = true, c.current = true;
      let F2 = d();
      Qr.reload({ ...F2, onStart: (A2) => {
        var _a;
        c.current = true, (_a = F2.onStart) == null ? void 0 : _a.call(F2, A2);
      }, onFinish: (A2) => {
        var _a;
        u(true), c.current = false, (_a = F2.onFinish) == null ? void 0 : _a.call(F2, A2), f2 || r4.disconnect();
      } });
    }, { rootMargin: `${i || 0}px` });
    return r4.observe(e.current), () => {
      r4.disconnect();
    };
  }, [e, d, i]), f2 || !m2 ? (0, import_react13.createElement)(s, { props: null, ref: e }, m2 ? o : l2) : m2 ? o : null;
};
